						...
						tbody.append(
					            $('<tr>')
					                ...
					                .append($('<td>'+'<a class="btn btn-warning" onclick=\'SALAARCOIRIS.livro.exibirEditU("'+listaDeUsuarios[i].idUsuario+'")\'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">'+
				                			  ...
				                			  '</svg></a>' +'</td>').append())
					                .append($('<td>'+'<a class="btn btn-danger" onclick=\'SALAARCOIRIS.livro.deletarU("'+listaDeUsuarios[i].idUsuario+'")\'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">'+
